...
function queueStrums(
  ...
  console.log('precacheTime:', precacheTime);
  ...
  function nextGenerationCall() {
    queueStrums(audioCtx, guitar, sequenceN, blockStartTime, chordIndex, precacheTime);
  }
  setTimeout(nextGenerationCall, generateIn * 1000);
}

function startGuitarPlaying(audioCtx, guitar) {
...
module.exports = startGuitarPlaying;
